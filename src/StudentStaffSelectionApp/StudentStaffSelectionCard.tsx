...
export const StudentStaffSelectionCard = () => { 
  ...
  const handleClick = (type: "Student" | "Staff") => { 
    ...
    <div className="container my-5"> <Row className="justify-content-center"> 
      <Col xs={12} md={5} className="mb-4"> 
        ...
        <Col xs={12} md={5} className="mb-4"> 
        <Card className="p-5" style={{ backgroundColor: "#FAF9F6", cursor: "pointer" }} onClick={() => handleClick("Staff")}> 
          <Card.Body> 
